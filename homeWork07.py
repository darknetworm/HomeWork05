    ...
    with open('forHomeWork07.txt') as dictionary:
        for subject in dictionary.readlines():
            ...
            if firmProfit >= 0:
                ...
                count += 1
                print(f'Фирма {firmName} получил прибыль в сумме {firmProfit} Пиастров')
            else:
                print(
                    f'Фирма {firmName} получила убытки в сумме {abs(firmProfit)} Пиастров и в расчет средней прибыли включена не будет')
